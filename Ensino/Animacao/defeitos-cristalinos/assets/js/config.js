...
export const ionicLatticeTypes = ['nacl'];
...
export const latticeOptions = [
  ...
  { value: 'nacl', label: 'Composto Iônico Genérico (NaCl)' }
];
...
export const modeConfig = {
  view: {
    ...
    icon: '◎',
    description: 'Navegue livremente pela rede cristalina. Nas estruturas metálicas/atômicas use SC, BCC ou FCC; para defeitos iônicos use o exemplo genérico tipo NaCl.',
    instructions: '',
  ...
  vacancy: {
    ...
    icon: '□',
    description: 'Defeito pontual em que um átomo ou íon está faltando em seu sítio regular na rede cristalina.',
    instructions: 'Clique em um átomo/íon para removê-lo. Clique na marca da lacuna para restaurá-lo.',
  ...
  substitutional: {
    ...
    instructions: 'Clique em um átomo/íon para substituí-lo por um átomo de soluto em vermelho.',
  ...
  interstitial: {
    ...
    icon: '+',
    description: 'Um átomo extra ocupa pequenos espaços vazios entre os átomos ou íons da rede.',
  ...
  frenkel: {
    ...
    icon: '⇄',
    ionicOnly: true,
    description: 'Defeito pontual característico de muitos cristais iônicos: um íon sai do sítio regular e passa para um interstício, formando uma lacuna + íon intersticial.',
    instructions: 'Disponível apenas no composto iônico tipo NaCl. Clique em um íon para deslocá-lo para um interstício próximo e formar o par de Frenkel.',
    implications: 'É comum em sólidos iônicos com grande diferença de tamanho entre cátions e ânions. Afeta a condutividade iônica mantendo neutralidade elétrica e estequiometria.',
    energyLevel: 70,
    energyText: 'Energia significativa, pois combina a formação de uma lacuna iônica e de um íon deslocado para um interstício.'
  },
  schottky: {
    title: 'Defeito de Schottky',
    icon: '✂',
    ionicOnly: true,
    description: 'Defeito pontual característico de cristais iônicos: vacâncias de cargas opostas são combinadas para preservar a neutralidade elétrica.',
    instructions: 'Disponível apenas no composto iônico tipo NaCl. Clique em um íon; o programa remove um cátion e um ânion para simular o par de Schottky.',
    ...
    energyLevel: 50,
    energyText: 'Energia moderada a alta, com estabilização parcial pela compensação eletrostática do par cátion-lacuna/ânion-lacuna.'
  }
};

export const atomScaleLimits = {
  min: 0.2,
  max: 1.4,
  step: 0.1
};

export const atomTypesWithMass = ['host', 'cation', 'anion', 'substitutional', 'interstitial', 'frenkel_interstitial'];
