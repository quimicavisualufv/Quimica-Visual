...
export const modeConfig = {
  ...
  frenkel: {
    ...
    icon: '⇄',
    ionicOnly: true,
    description: 'Defeito pontual exclusivo de cristais iônicos: um íon sai do seu sítio regular e passa para um interstício, formando uma lacuna + íon intersticial.',
  ...
  schottky: {
    ...
    icon: '✂',
    ionicOnly: true,
    description: 'Defeito pontual exclusivo de cristais iônicos: lacunas de cátion e ânion são criadas em par para preservar a neutralidade elétrica.',
