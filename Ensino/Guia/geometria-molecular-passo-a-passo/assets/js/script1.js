...
(function(){
  ...
  var quickWhiteBgWrap = document.getElementById('quickWhiteBgWrap');
  var leftAnglesToggle = document.getElementById('leftAnglesToggle');
  ...
  function __syncQuickThemeState(v){
    v = !!v;
    if(quickWhiteBgWrap) quickWhiteBgWrap.classList.toggle('lightBgActive', v);
    if(leftAnglesToggle) leftAnglesToggle.classList.toggle('lightBgActive', v);
  }
