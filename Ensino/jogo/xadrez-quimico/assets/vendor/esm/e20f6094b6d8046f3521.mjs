...
import { Vector2, Matrix4 } from "./b90800dc0c1a3c8b995a.mjs";

// node_modules/maath/dist/matrix-baa530bf.esm.js
import { Matrix3 } from "./b90800dc0c1a3c8b995a.mjs";
...
import { Quaternion, Vector3 as Vector32 } from "./b90800dc0c1a3c8b995a.mjs";

// node_modules/maath/dist/misc-19a3ec46.esm.js
import { Vector3, Matrix3 as Matrix32 } from "./b90800dc0c1a3c8b995a.mjs";
...
import { Color, Vector3 as Vector33, Quaternion as Quaternion2, Matrix4 as Matrix42, Vector2 as Vector22, Vector4, Euler, Spherical } from "./b90800dc0c1a3c8b995a.mjs";
...
var vl3d = /* @__PURE__ */ new Vector33();
var _q1 = /* @__PURE__ */ new Quaternion2();
var _q2 = /* @__PURE__ */ new Quaternion2();
var _m1 = /* @__PURE__ */ new Matrix42();
var _position = /* @__PURE__ */ new Vector33();
...
var qt = /* @__PURE__ */ new Quaternion2();
...
var mat = /* @__PURE__ */ new Matrix42();
var mPos = /* @__PURE__ */ new Vector33();
var mRot = /* @__PURE__ */ new Quaternion2();
var mSca = /* @__PURE__ */ new Vector33();
var aM;
var bM;
var cM;
...
import * as THREE from "./b90800dc0c1a3c8b995a.mjs";
...
import { Vector3 as Vector35, Vector2 as Vector24 } from "./b90800dc0c1a3c8b995a.mjs";
function bufferToVectors(buffer2) {
  var stride = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3;
  var p2 = [];
  for (var i = 0, j = 0; i < buffer2.length; i += stride, j++) {
    if (stride === 3) {
      p2[j] = new Vector35(buffer2[i], buffer2[i + 1], buffer2[i + 2]);
    } else {
      p2[j] = new Vector24(buffer2[i], buffer2[i + 1]);
    }
  }
  return p2;
}
...
import "./b90800dc0c1a3c8b995a.mjs";
export {
  buffer,
  easing,
  geometry,
